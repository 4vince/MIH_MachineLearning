...
def main(
    input_path=str(Path(__file__).parent.parent / "data" / "raw" / "LusitaniaManifest.csv"),
    output_path=str(Path(__file__).parent.parent / "data" / "cleaned" / "lusitania_cleaned.csv"),
):
